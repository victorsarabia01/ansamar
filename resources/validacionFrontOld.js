...
$(document).ready(function() {
  ...
  //var table = $('#example').DataTable();
    ...
    if (controlador == 'empleado'){
      ...
      {"data": 'estado'},
       {"defaultContent": 
       '<button type="button" title="Editar" class="editar btn btn-outline-primary"><i class="bi bi-pencil-square"></i> </button> <button type="button" title="status" class="status btn btn-outline-secondary"><i class="bi bi-toggle2-off"></i> </button> <button type="button" title="Editar" class="eliminar btn btn-outline-danger"><i class="bi bi-trash"></i> </button>'}
      ];
