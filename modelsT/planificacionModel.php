...
class planificacion_model extends conexion
{
	...
	{
		if ($metodo == "listarTodosConsultorios") {
			return self::listarTodosConsultorios();
		}
		if ($metodo == "listarTodosTurnos") {
			return self::listarTodosTurnos();
		}
		if ($metodo == "listarDiaSemana") {
			return self::listarDiaSemana();
		}
		if ($metodo == "listarTodosDoctores") {
			return self::listarTodosDoctores();
		}
		if ($metodo == "listarStatus") {
			return self::listarStatus();
		}
		if ($metodo == "listarPlanificacion") {
			return self::listarPlanificacion();
		}


		if ($metodo == "consultarSillas" && $param1 != "") {
			return self::consultarSillas($param1);
		}
		if ($metodo == "cargarPlanificacionAEditar" && $param1 != "") {
			return self::cargarPlanificacionAEditar($param1);
		}
		if ($metodo == "buscarRegistroPlanificacion" && $param1 != "") {
			return self::buscarRegistroPlanificacion($param1);
		}
	...
	{
		if ($metodo == "registrarPlanificacion" && !empty($param1)) {
			return self::registrarPlanificacion($param1);
		}
	}
	public function Modificar($metodo, $param1 = [])
	{
		if ($metodo == "modificarPlanificacion" && !empty($param1)) {
			return self::modificarPlanificacion($param1);
		}
	}
	public function Eliminar($metodo, $param1 = "")
	{
		if ($metodo == "deletePlanificacion" && $param1 != "") {
			return self::deletePlanificacion($param1);
		}
		if ($metodo == "habilitarPlanificacion" && $param1 != "") {
			return self::habilitarPlanificacion($param1);
		}
	}
	...
	private function modificarPlanificacion(planificacion_model $data)
	{
		try {
			...
			$result = $this->CNX->prepare($query)->execute(array($data->id_consultorio, $data->turno, $data->id_doctor, $data->diaSemana, $data->id));
			return $result;
		} catch (Exception $e) {
			die($e->getMessage());
		}
	...
	private function registrarPlanificacion(planificacion_model $data)
	{
		try {
			...
			$result = $this->CNX->prepare($query)->execute(array($data->id_consultorio, $data->turno, $data->id_doctor, $data->diaSemana, '1'));
			return $result;
		} catch (Exception $e) {
			die($e->getMessage());
		}
	...
	private function deletePlanificacion($id)
	{
		try {
	...
	private function deletePlanificacionx($id)
	{
		try {
	...
	private function habilitarPlanificacion($id)
	{
		try {
