       ...
       <div class="alert alert-success" role="alert">
                    ...
                    <form class="form-horizontal" method="post" id="formulario" name="formulario" action="">
                        ...
                        <div class="col-md-40">
                            ...
                            <input type="text area" onkeypress="buscarReg();" onKeyUp="" id="descripcion" name="descripcion" onkeypress="return permite(event, 'num_car')" class="form-control" value="<?php echo $this->alm->descripcion; ?>" aria-describedby="emailHelp" placeholder="Nombre" maxlength="50" required>
