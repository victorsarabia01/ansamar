  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <a href="index.php?c=tipoempleado" class="btn-close" aria-label="Close"></a>
      </div>
      <div class="modal-body">
       <div class="alert alert-success" role="alert">
                            <h3>Modificar tipo de empleado</h3>
                       
                        </div>
                  
                    <form class="form-horizontal" method="post" action="index.php?c=tipoempleado&a=modificar">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-40">
                            ...
                            <input type="text area" id="descripcion" name="descripcion" class="form-control mayusculas buscar" onKeyUp="buscarTipo();" value="<?php echo $this->alm->descripcion; ?>" aria-describedby="emailHelp" placeholder="Nombre" maxlength="50" required>
              
                        </div>
                        <div id="verificarRegistroTipo"></div>
                        ...
                        <div class="col-md-15">
                          ...
                          <select name="status" id="status" class="form-select form-select-lg mb-1" aria-label="Ejemplo de .form-select-lg" required>
                            ...
                            <a class="btn btn-outline-danger" href="index.php?c=tipoempleado">Cancelar</a>
