...
<div class="modal" style="overflow-y: scroll;" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog" style="min-width: 75%;">
    ...
    <div class="modal-content">
      <form class="form-horizontal" method="post" action="index.php?c=modulo&a=modificar">

        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel"></h5>
          <a href="index.php?c=modulo" class="btn-close" aria-label="Close"></a>
        </div>
          ...
          <div class="container-fluid">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $this->alm->nombre; ?>" aria-describedby="emailHelp" placeholder="Nombre del modulo" maxlength="50" required>
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-outline-danger" href="index.php?c=modulo">Cancelar</a>
        </div>
      </form> 
